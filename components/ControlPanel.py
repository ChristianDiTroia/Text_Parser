...
class ControlPanel(CommonFrame):
    ...
    def __init__(self, master):
        ...
        self.upload_button.grid(row=0, column=0, padx=40, pady=(40, 0), sticky="ew")

        # Save button
        self.save_button = SaveButton(self)
        self.save_button.grid(row=1, column=0, padx=40, pady=(40, 0), sticky="ew")

        # Lock text switch
        self.lock_text_switch = ControlSwitch(self)
        self.lock_text_switch.grid(row=3, column=0, padx=40, pady=(40, 0), sticky="ew")

        # Token count entry
        self.token_count_entry = TokenNumberComboBox(self)
        self.token_count_entry.grid(row=4, column=0, padx=40, pady=(40, 0), sticky="ew")
